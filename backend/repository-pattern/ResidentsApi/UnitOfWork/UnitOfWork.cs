...
namespace ResidentsApi.UnitOfWork
{
    ...
    //In our example, TContext is going to be ResidentDBContext
    ...
    public class UnitOfWork<TContext> : IUnitOfWork<TContext>, IDisposable where TContext : DbContext, new()
    {
        ...
        //This is nothing but we are storing the DBContext (ResidentDBContext) object in Context Property
        public UnitOfWork()
        {
